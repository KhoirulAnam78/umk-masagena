                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" required name="deskripsi" id="deskripsi">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input required type="number" autofocus
