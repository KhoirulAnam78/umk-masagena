...
<body>
    ...
    <!-- Firm Visit Start -->
    <div class="container-fluid bg-primary bg-icon mt-5 py-6" id="kontak">
        <div class="container">
            <div class="row g-5 align-items-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="#">UMK MASAGENA</a>, All Right Reserved.
                    </div>
